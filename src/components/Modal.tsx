  ...
  return (
    <div
      ...
      <XMarkIcon
        ...
        onClick={toggle}
      />
      <div className="overscroll-none p-5 sm:p-10 border-border md:h-fit max-h-screen h-screen md:border bg-bg md:rounded-lg w-full md:max-w-xl cursor-auto overflow-auto z-50">
