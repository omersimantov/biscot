  ...
  return (
    <div
      ...
      <XMarkIcon
        ...
        onClick={toggle}
      />
      <div className="md:my-10 overscroll-none p-5 sm:p-10 border-border md:h-fit md:max-h-[calc(100vh-5rem)] h-screen md:border bg-bg md:rounded-lg w-full md:max-w-xl cursor-auto overflow-auto">
